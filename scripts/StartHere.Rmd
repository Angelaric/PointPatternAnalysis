...
period_list <- c("Pre", "NEO", "CHALCO", "BA","EBA", "LBA", "IA", "EIA", "LIA", "HELLEN", "RP", "LRP", "LA_","EMA", "HMA", "LMA", 
                 "MA_XIV", "MA_XVII")
...
# Save results
# dir.create("../outputs")
write_csv(as.data.frame(result), "../outputs/Box1_NNA.csv")
